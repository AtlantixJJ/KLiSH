...
class EncodeCarTransforms(TransformsConfig):
    def __init__(self, opts):
        super(EncodeCarTransforms, self).__init__(opts)
...
class SegToCarTransforms(TransformsConfig):
    def __init__(self, opts):
        super(SegToCarTransforms, self).__init__(opts)
