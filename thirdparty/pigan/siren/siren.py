...
class TALLSIREN(nn.Module):
    ...
    def forward_with_frequencies_phase_shifts_feature(self, input, frequencies, phase_shifts, ray_directions, **kwargs):
        frequencies = frequencies*15 + 30
        ...
        return torch.cat([rbg, sigma], dim=-1), x
...
class SPATIALSIRENBASELINE(nn.Module):
    ...
    def forward_with_frequencies_phase_shifts_feature(self, input, frequencies, phase_shifts, ray_directions, **kwargs):
        ...
        return torch.cat([rbg, sigma], dim=-1), feature
